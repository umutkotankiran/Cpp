...
-------------------------------------------------------------------------------------------------------------------------
ÇOK ÖNEMLİ !!!!!!!!!!!!!!!!!!!!!!!!!
Bir sağ taraf değeri referansına biz farklı türden bir sol taraf değeri ile de ilkdeğer verebiliriz.
Bu durumda yine farklı türden sol taraf değeri  derleyici  tarafından referans ile aynı türden
geçici geçici bir nesne yaratılarak o geçici nesneye yerleştirilmekte ve geçici nesnenin adresi referansa atanmaktadır. 
Örneğin:
double d = 3.14;
int &&r = d;            // geçerli!
