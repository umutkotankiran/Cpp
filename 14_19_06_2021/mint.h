...
public:
	...
	friend bool operator<(const Mint& x, const Mint& y) //ADL VAR
	{
		return x.mval < y.mval; // sınıfa friend olduğundan private bölüme erişim bir hata değil.ADL var yine 
	}
	friend bool operator==(const Mint& x, const Mint& y) //ADL VAR
	{
...
inline Mint operator+(Mint left, const Mint& right) // en son bunu koyduk.Copy elision olabilsin diye.
{
	return left += right;
