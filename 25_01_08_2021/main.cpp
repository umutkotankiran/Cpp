...
DÖNDÜRMÜYOR. DYNAMIC CASTTE İSE TRUE DÖNDÜRÜYORDU. ÇOK KRİTİK BİR FARK BU.
...
int main()
{
	...
	func("Haydar"); // T türü const int [7] .		func ın içi func(const int (&r)[7])
